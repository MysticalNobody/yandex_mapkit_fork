...
class YandexBicycle {
  ...
  static BicycleResultWithSession requestRoutes(
      {required List<RequestPoint> points, required BicycleVehicleType bicycleVehicleType}) {
    ...
    final result =
        channel.invokeMethod('requestRoutes', params).then((result) => BicycleSessionResult._fromJson(result));

    return BicycleResultWithSession._(session: BicycleSession._(id: params['sessionId']), result: result);
  }
}
