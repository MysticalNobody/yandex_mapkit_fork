...
class YandexSearch {
  ...
  static SearchResultWithSession searchByText(
      {required String searchText, required Geometry geometry, required SearchOptions searchOptions}) {
    ...
    final result = channel.invokeMethod('searchByText', params).then((result) => SearchSessionResult._fromJson(result));
  ...
  static SearchResultWithSession searchByPoint(
    ...
    final result =
        channel.invokeMethod('searchByPoint', params).then((result) => SearchSessionResult._fromJson(result));
