...
class YandexSuggest {
  ...
  static SuggestResultWithSession getSuggestions(
      {required String text, required BoundingBox boundingBox, required SuggestOptions suggestOptions}) {
    ...
    final result =
        channel.invokeMethod('getSuggestions', params).then((result) => SuggestSessionResult._fromJson(result));

    return SuggestResultWithSession._(session: SuggestSession._(id: params['sessionId']), result: result);
  }
}
