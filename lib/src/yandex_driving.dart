...
class YandexDriving {
  ...
  static DrivingResultWithSession requestRoutes(
      {required List<RequestPoint> points, required DrivingOptions drivingOptions}) {
    ...
    final result =
        channel.invokeMethod('requestRoutes', params).then((result) => DrivingSessionResult._fromJson(result));

    return DrivingResultWithSession._(session: DrivingSession._(id: params['sessionId']), result: result);
  }
}
